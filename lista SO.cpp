...
// Esse foi o codigo que usei de base para tentar fazer a atividade, não entendi nada, não sei programar em C++, e  acabei não conseguindo realizar o projeto a tempo, porque eu não queria apenas copiar e colar, mas entender o que euusestava fazendo.
